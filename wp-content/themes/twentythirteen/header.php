	...
	<div id="page" class="hfeed site">
		<header id="masthead" class="site-header" role="banner">
			...
			<div id="navbar" class="navbar">
                ...
                <a href="http://quimbalar.herokuapp.com/carrinho-de-compras" style="float:right;"><img src="http://quimbalar.s3-eu-west-1.amazonaws.com/wp-content/uploads/2016/04/carrinho-de-compras-quimbalar-vazio.png"><strong><?php _e( 'Total', 'woocommerce' ); ?></strong></a><br>
